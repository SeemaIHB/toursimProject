    ...
    <div class="container py-5">
        <div class="row gx-5 justify-content-center">
                ...
                <div  style="max-width: 600px;">
                    <h1 style="color:#ffffff; position: absolute;right: 700px;top: 70px;">Results</h1>
                </div>
                <p  align="center" style="color:whitesmoke;font-size:30px;"><?php echo $_POST['value'];?></p>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        ...
        <div class="owl-carousel testimonial-carousel">
            ...
            $qrystr = "SELECT * FROM `resturant` WHERE `location`='$_POST[value]'";
            $res = $db->query($qrystr);
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" style="margin-bottom: 75px;">
    <div class="container">
        ...
        <div class="row g-5">
            ...
            $qrystr = "SELECT * FROM `hospitals` WHERE `address`='$_POST[value]'";
            $res = $db->query($qrystr);
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
    <div class="container">
        ...
        <div class="row g-5">
            ...
            $qrystr = "SELECT * FROM `hotels` WHERE `address`='$_POST[value]'";
            $res = $db->query($qrystr);
